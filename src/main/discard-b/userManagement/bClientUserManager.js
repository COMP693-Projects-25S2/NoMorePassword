...
class BClientUserManager {
    ...
    /**
     * Auto-fetch title for loading records (B-Client doesn't track visit history)
     */
    async autoFetchTitleForLoadingRecords() {
        try {
            // B-Client is an enterprise server and doesn't track visit history
            console.log('[BClientUserManager] B-Client does not track visit history, skipping auto-fetch');
            return { updated: 0, total: 0 };
        } catch (error) {
